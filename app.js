    ...
    openPolicyModal(type) {
        ...
        const policies = {
            privacy: {
                ...
                content: `<h3>1. Information We Collect</h3><p>We collect information you provide directly to us when requesting quotations, technical service, or contacting us. This includes your name, phone number, email address, and device specifications.</p><h3>2. How We Use Your Information</h3><p>We use your information to provide customer support, generate quotations, dispatch technical engineers, and improve our services. We do not sell or share your personal information with third parties.</p><h3>3. Data Security</h3><p>We implement robust security measures to protect your personal data on our local systems and secure servers.</p>`
            },
            shipping: {
                title: "Shipping & Delivery Policy",
                content: `<h3>1. Delivery Areas</h3><p>We offer prompt delivery across Nairobi and all major towns in Kenya.</p><h3>2. Delivery Timelines</h3><p><strong>Nairobi & Environs:</strong> Same-day delivery (within 2-4 hours) for toners, spare parts, and consumable supplies.<br><strong>Rest of Kenya:</strong> Prompt parcel shipping via trusted regional couriers (arrives within 24-48 hours).</p><h3>3. Delivery Charges</h3><p>Delivery fees vary depending on the destination and the size of the equipment. Small consumables may qualify for free delivery inside Nairobi CBD.</p>`
            },
            refund: {
                title: "Refund & Returns Policy",
                content: `<h3>1. Returns Eligibility</h3><p>Consumables, toners, and spare parts are eligible for return within 7 days of purchase if they are in their original, unopened packaging.</p><h3>2. Equipment Warranties</h3><p>All our refurbished copiers come with a comprehensive 1-Year Warranty or click-count guarantee. If a major hardware defect occurs under normal use, our technicians will repair or replace the unit in accordance with the SLA agreement.</p><h3>3. Refunds Process</h3><p>Once your returned item is received and inspected, we will notify you of the approval or rejection of your refund. Approved refunds will be processed via bank transfer or M-Pesa within 3-5 business days.</p>`
            },
            terms: {
                title: "Terms & Conditions",
                content: `<h3>1. Terms of Service</h3><p>By accessing our website and services, you agree to comply with our business terms, warranty guidelines, and local regulations.</p><h3>2. Quotations and Pricing</h3><p>All prices generated by our interactive quotation tool are estimates. Official binding invoices will be generated and sent via WhatsApp or Email by our sales agents.</p><h3>3. Service Agreements</h3><p>Technical repairs and SLA maintenance services are subject to the terms signed in the service contract. Warranty is void if unauthorized technicians tamper with the equipment seal.</p>`
            }
        };
